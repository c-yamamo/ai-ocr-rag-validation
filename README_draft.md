...
本構成では、基本はワークフロー型としつつ、  
OCR失敗や判定不確実性に対しては **エージェント的に処理を制御** する設計としています。

---

## 4. 技術構成（予定）

本検証では、**無料または低コストで検証可能な構成**をベースとしつつ、  
実務導入を想定して **マネージドサービスへ差し替え可能な設計** としています。
